  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested menu_item" do
        ...
        MenuItem.any_instance.should_receive(:update_attributes).with({ "restaurant_id" => "1" })
        put :update, {:id => menu_item.to_param, :menu_item => { "restaurant_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the menu_item as @menu_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        MenuItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => menu_item.to_param, :menu_item => { "restaurant_id" => "invalid value" }}, valid_session
        assigns(:menu_item).should eq(menu_item)
      end
